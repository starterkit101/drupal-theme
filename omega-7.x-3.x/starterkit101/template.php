 ...
 */
function serijakala_css_alter(&$css) {
  // Get current themes path.
  $theme_path = drupal_get_path('theme', variable_get('serijakala', NULL));
...
// Textfield
function serijakala_textfield($variables) {
...
// Password
function serijakala_password($variables) {
  $element = $variables ['element'];
...
// Select
function serijakala_select($variables) {
  $element = $variables ['element'];
...
// Checkbox
function serijakala_checkbox($variables) {
  $element = $variables ['element'];
...
function serijakala_preprocess_node(&$vars) {
